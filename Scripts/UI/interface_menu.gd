...
func _ready():
	...
	$"interface_menu_tabs/Single Frames/values/playerframe_hp_width_entry".text = str(player_hpbar.size.x)
	$"interface_menu_tabs/Single Frames/values/playerframe_hp_height_entry".text = str(player_hpbar.size.y)
	$"interface_menu_tabs/Single Frames/values/playerframe_hp_h_position_entry".text = str(player_hpbar.position.x)
	$"interface_menu_tabs/Single Frames/values/playerframe_hp_v_position_entry".text = str(player_hpbar.position.y)
	...
	$"interface_menu_tabs/Single Frames/dropdowns/playerframe_hp_showtoggle".selected = player_hpbar.visible
	$"interface_menu_tabs/Single Frames/dropdowns/playerframe_hp_orientation_entry".selected = player_hpbar.fill_mode
	...
	$"interface_menu_tabs/Single Frames/values/playerframe_res_width_entry".text = str(player_resbar.size.x)
	$"interface_menu_tabs/Single Frames/values/playerframe_res_height_entry".text = str(player_resbar.size.y)
	$"interface_menu_tabs/Single Frames/values/playerframe_res_h_position_entry".text = str(player_resbar.position.x)
	$"interface_menu_tabs/Single Frames/values/playerframe_res_v_position_entry".text = str(player_resbar.position.y)
	add_item_showhide($"interface_menu_tabs/Single Frames/dropdowns/playerframe_res_showtoggle")
	add_item_orientation($"interface_menu_tabs/Single Frames/dropdowns/playerframe_res_orientation_entry")
	$"interface_menu_tabs/Single Frames/dropdowns/playerframe_res_showtoggle".selected = player_resbar.visible
	$"interface_menu_tabs/Single Frames/dropdowns/playerframe_res_orientation_entry".selected = player_resbar.fill_mode
...
func _on_interface_menu_apply_pressed():
	...
	player_hpbar.size.y = int($"interface_menu_tabs/Single Frames/values/playerframe_hp_height_entry".text)
	player_hpbar.position.x = int($"interface_menu_tabs/Single Frames/values/playerframe_hp_h_position_entry".text)
